...
texto = "Ciência de Dados é uma ótima alternativa para carreira./n"
texto = texto + "Esses profissionais costumam manipular python./n"
...
for palavra in texto.split(): # quando o split possui seus parênterses vazios, ele assume espaço como separação.
